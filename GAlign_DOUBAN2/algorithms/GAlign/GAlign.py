...
class GAlign(NetworkAlignmentModel):
    ...
    """
    def __init__(self, G1, G2, alignment_dict, idx1_dict, idx2_dict, source_dataset, target_dataset, args):
        """
    ...
    def multi_level_embed(self, source_A_hat, target_A_hat, source_feats, target_feats):
        ...
        for epoch in range(self.args.GAlign_epochs):
            ...
            for i in range(2):
                ...
                # Douban       
                # loss = 0.00001*(loss_dgi + loss_dgi_diff + loss_dgi_diff_feats) + diff_feats_consistency_loss
